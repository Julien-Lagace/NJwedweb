  ...
  en: {
    ...
    schedule: {
      ...
      days: [
        {
          id: 'thursday',
          label: 'Thursday - Mehndi (Unofficial Event)',
          date: 'June 3, 2027',
          location: '',
          items: [
            {
    ...
    attire: {
      ...
      curatedShopButton: 'Visit Twirlin Style',
      discountText: 'Use code NETRA15 on Twirlin Style: ',
      viewInspirationButton: 'View inspiration',
      eventShopButton: 'Shop this look',
      ...
      purchaseLinks: [
        ...
        { label: 'Kalki Fashion', href: 'https://www.kalkifashion.com' },
      ],
      rentalLinks: [
      ...
      events: [
        {
          ...
          eyebrow: 'Mirror Work',
          title: 'Sangeet',
          vibe: 'Lights, music, celebration.',
          desc: 'Any colour with mirror work, reflective details, jewel tones and festive sparkle.',
          palette: ['#d12b73', '#7b4ea3', '#2c6099', '#4b9292', '#bfc4ca'],
          inspirationUrl: 'https://in.pinterest.com/aashudariyani/mirror-work-sangeet-netra-adn-julien/',
        ...
        {
          id: 'haldi',
          eyebrow: 'Peach Sorbet',
          title: 'Haldi',
          vibe: 'Bright hues, happier you.',
          desc: 'Peach, coral, apricot, warm pink and sunshine yellow.',
          palette: ['#f5a08a', '#eb6b6b', '#f37b3f', '#f8bb50', '#f1e4c8'],
          inspirationUrl: 'https://in.pinterest.com/aashudariyani/peach-coral-haldi-netra-and-julien/',
        ...
        },
        {
          ...
          eyebrow: 'Pastel',
          title: 'Wedding',
          vibe: 'Soft hues. Timeless love.',
          desc: 'Blush, lilac, sage, powder blue and champagne. Deep maroon is reserved for the bride.',
          palette: ['#efb2b2', '#bea0e8', '#a5b79a', '#9cc4e5', '#ddd0bd'],
          inspirationUrl: 'https://in.pinterest.com/aashudariyani/pastel-wedding-netra-and-julien/',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.xek0eqnw53ua',
          gentlemen: [
            'Kurta requested',
            'Formal traditional fabrics'
          ],
          ladies: [
        ...
        {
          id: 'reception',
          eyebrow: 'Midnight Twilight',
          title: 'Reception',
          vibe: 'A night to remember.',
          desc: 'Midnight blue, navy, lavender, purple, black and silver - glitz and glam encouraged.',
          palette: ['#21477d', '#294996', '#744182', '#171717', '#bfc4ca'],
          inspirationUrl: 'https://in.pinterest.com/aashudariyani/midnight-twilight-reception-netra-and-julien/',
  ...
  fr: {
    ...
    schedule: {
      ...
      days: [
        {
          id: 'thursday',
          label: 'Jeudi - Mehndi (Événement non officiel)',
          date: '3 juin 2027',
          location: '',
          items: [
            {
    ...
    attire: {
      ...
      curatedShopUrl: 'https://twirlinstyle.com/',
      curatedShopButton: 'Visiter Twirlin Style',
      discountText: 'Utilisez le code NETRA15 sur Twirlin Style : ',
      viewInspirationButton: 'Voir l’inspiration',
      eventShopButton: 'Magasiner ce look',
      ...
      events: [
        {
          id: 'sangeet',
          eyebrow: 'Broderies miroir',
          title: 'Sangeet',
          vibe: 'Lumières, musique, célébration.',
          desc: 'N\'importe quelle couleur avec broderies miroir, détails réfléchissants, tons bijoux et éclat festif.',
          palette: ['#d12b73', '#7b4ea3', '#2c6099', '#4b9292', '#bfc4ca'],
          inspirationUrl: 'https://in.pinterest.com/aashudariyani/mirror-work-sangeet-netra-adn-julien/',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.a0t2ursocbnd',
          gentlemen: [
        ...
        {
          id: 'haldi',
          eyebrow: 'Sorbet pêche',
          title: 'Haldi',
          vibe: 'Des couleurs vives, plus de bonheur.',
          desc: 'Pêche, corail, abricot, rose chaleureux et jaune soleil.',
          palette: ['#f5a08a', '#eb6b6b', '#f37b3f', '#f8bb50', '#f1e4c8'],
          inspirationUrl: 'https://in.pinterest.com/aashudariyani/peach-coral-haldi-netra-and-julien/',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.0',
          gentlemen: [
        ...
        },
        {
          ...
          eyebrow: 'Pastel',
          title: 'Mariage',
          vibe: 'Teintes douces. Amour intemporel.',
          desc: 'Blush, lilas, sauge, bleu pâle et champagne. Le bordeaux foncé est réservé à la mariée.',
          palette: ['#efb2b2', '#bea0e8', '#a5b79a', '#9cc4e5', '#ddd0bd'],
          inspirationUrl: 'https://in.pinterest.com/aashudariyani/pastel-wedding-netra-and-julien/',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.xek0eqnw53ua',
          gentlemen: [
        ...
        {
          id: 'reception',
          eyebrow: 'Crépuscule nocturne',
          title: 'Réception',
          vibe: 'Une soirée inoubliable.',
          desc: 'Bleu nuit, marine, lavande, violet, noir et argent. Les tenues brillantes sont encouragées.',
          palette: ['#21477d', '#294996', '#744182', '#171717', '#bfc4ca'],
          inspirationUrl: 'https://in.pinterest.com/aashudariyani/midnight-twilight-reception-netra-and-julien/',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.rpxfapsbuksx',
          gentlemen: [
