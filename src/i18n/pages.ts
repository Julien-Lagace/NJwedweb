export const pages = {
  en: {
    ...
    attire: {
      ...
      gentlemen: 'Gentlemen',
      ladies: 'Ladies',
      viewInspirationButton: 'View Event Inspiration',
      ...
      curatedShopLabel: 'Discount',
      curatedShopIntro: 'A hand-picked edit of celebration-ready looks, curated by Twirlin Style for our wedding guests.',
      curatedShopButton: 'Twirl In Style',
      eventShopButton: 'Shop Curated Guest Outfits',
      curatedShopUrl: 'https://twirlinstyle.com/',
      discountText: '15% off with code NETRA15 specifically for the Twirl In Style website.',
      purchaseHeading: 'Order outfits',
      rentalHeading: 'Rent outfits',
      purchaseLinks: [
        { label: 'Twirl In Style', href: 'https://twirlinstyle.com/' },
        ...
        { label: 'Kalki Fashion', href: 'https://global.kalkifashion.com' },
      ],
      rentalLinks: [
      ...
      events: [
        {
          ...
          womenImage: 'lehenga',
          image: 'sangeet',
          palette: ['#d12678', '#7950a0', '#28639b', '#579291', '#c5cbd0'],
          inspirationUrl: 'https://www.pinterest.com/search/pins/?q=sangeet%20mirror%20work%20jewel%20tones%20outfits',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.a0t2ursocbnd',
          desc: 'Lights, music, celebration.',
          paletteNote: 'Any colour with mirror work, reflective details, jewel tones and festive sparkle.',
          gentlemen: [
        ...
        },
        {
          ...
          womenImage: 'dress',
          image: 'haldi',
          palette: ['#f59a7b', '#ed706d', '#f48445', '#f8bd50', '#f1e2c3'],
          inspirationUrl: 'https://www.pinterest.com/search/pins/?q=haldi%20peach%20coral%20yellow%20outfits',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.0',
          desc: 'Bright hues, happier you.',
          paletteNote: 'Peach, coral, apricot, warm pink and sunshine yellow.',
          gentlemen: [
        ...
        },
        {
          ...
          womenImage: 'saree',
          image: 'wedding',
          palette: ['#f1b2b1', '#b99be5', '#a8bd9e', '#9fc7e5', '#ded2c2'],
          inspirationUrl: 'https://www.pinterest.com/search/pins/?q=indian%20wedding%20pastel%20outfits',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.xek0eqnw53ua',
          desc: 'Soft hues. Timeless love.',
          paletteNote: 'Blush, lilac, sage, powder blue and champagne. Deep maroon is reserved for the bride.',
          gentlemen: ['Kurta requested', 'Formal traditional fabrics'],
          ladies: [
        ...
        },
        {
          id: 'reception',
          title: 'Reception',
          vibe: 'Midnight Twilight',
          menImage: 'suit',
          womenImage: 'saree',
          image: 'reception',
          palette: ['#1f4e86', '#294d94', '#714481', '#171717', '#c5cbd0'],
          inspirationUrl: 'https://www.pinterest.com/search/pins/?q=indian%20reception%20midnight%20blue%20navy%20glam%20outfits',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.rpxfapsbuksx',
          desc: 'A night to remember.',
          paletteNote: 'Midnight blue, navy, lavender, purple, black and silver - glitz and glam encouraged.',
          gentlemen: [
  ...
  fr: {
    ...
    attire: {
      ...
      gentlemen: 'Hommes',
      ladies: 'Femmes',
      viewInspirationButton: 'Voir l’inspiration de l’événement',
      ...
      curatedShopLabel: 'Rabais',
      curatedShopIntro: 'Une sélection de tenues prêtes pour la fête, choisies par Twirlin Style pour les invités de notre mariage.',
      curatedShopButton: 'Twirl In Style',
      eventShopButton: 'Magasiner les tenues choisies pour les invités',
      curatedShopUrl: 'https://twirlinstyle.com/',
      discountText: '15 % de rabais avec le code NETRA15, exclusivement sur le site Twirl In Style.',
      ...
      events: [
        {
          ...
          inspirationUrl: 'https://www.pinterest.com/search/pins/?q=sangeet%20mirror%20work%20jewel%20tones%20outfits',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.a0t2ursocbnd',
          desc: 'Lumières, musique, célébration.',
          paletteNote: 'N\'importe quelles couleurs avec broderies miroir, détails réfléchissants, tons bijoux et éclat festif.',
          gentlemen: [
        ...
        },
        {
          ...
          inspirationUrl: 'https://www.pinterest.com/search/pins/?q=haldi%20peach%20coral%20yellow%20outfits',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.0',
          desc: 'Des couleurs vives pour une journée joyeuse.',
          paletteNote: 'Pêche, corail, abricot, rose chaud et jaune soleil.',
          gentlemen: [
        ...
        },
        {
          ...
          inspirationUrl: 'https://www.pinterest.com/search/pins/?q=indian%20wedding%20pastel%20outfits',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.xek0eqnw53ua',
          desc: 'Des tons doux pour un amour intemporel.',
          paletteNote: 'Blush, lilas, sauge, bleu poudré et champagne. Le marron est réservé à la mariée.',
          gentlemen: [
            'Kurta demandé',
        ...
        },
        {
          ...
          inspirationUrl: 'https://www.pinterest.com/search/pins/?q=indian%20reception%20midnight%20blue%20navy%20glam%20outfits',
          curatedShopUrl: 'https://docs.google.com/document/d/1dvWpEripM6eAvwIKzsrPn3zPz-gzXvUbHxdqFxjrDoM/edit?tab=t.rpxfapsbuksx',
          desc: 'Une nuit inoubliable.',
          paletteNote: 'Bleu nuit, marine, lavande, violet, noir et argent. Les paillettes sont encouragées.',
          gentlemen: [
